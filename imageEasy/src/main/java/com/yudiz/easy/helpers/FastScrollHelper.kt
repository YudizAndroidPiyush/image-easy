...
import com.yudiz.easy.utility.sScrollbarAnimDuration
...
internal fun ImageEasyBindings.setViewPositions(y: Float) {
    ...
    gridLayout.fastscrollBubble.y = handleY + fragmentImageEasy.root.context.toPx(60f)
    gridLayout.fastscrollHandle.y = handleY.toFloat()
}


fun ImageEasyBindings.hideScrollbar() {
...
fun scrollListener(
    fragment: com.yudiz.easy.ImageEasyFragment,
...
fun ImageEasyBindings.hideBubble() {
...
fun ImageEasyBindings.setRecyclerViewPosition(y: Float) {
...
fun ImageEasyBindings.showBubble() {
    if (!gridLayout.fastscrollBubble.isVisible) {
