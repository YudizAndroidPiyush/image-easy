...
import com.yudiz.easy.utility.IMAGE_VIDEO_URI
...
fun FragmentActivity.setUpMargins(binding: ImageEasyBindings) {
    val height =
...
fun Context.toast(size: Int) {
    Toast.makeText(
        this, String.format(
            resources.getString(R.string.selection_limiter),
            size
        ), Toast.LENGTH_SHORT
    ).show()
}
