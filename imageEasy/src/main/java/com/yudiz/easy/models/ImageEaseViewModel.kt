package com.yudiz.easy.models

import androidx.lifecycle.LiveData
import androidx.lifecycle.MutableLiveData
import androidx.lifecycle.ViewModel
import com.yudiz.easy.helpers.LocalResourceManager
import com.yudiz.easy.interfaces.ImageEasyLifecycle
...
internal class ImageEasyViewModel : ViewModel(), ImageEasyLifecycle {
    ...
    override fun onImageLongSelected(element: Img?, position: Int, callback: (Boolean) -> Boolean) {
        if (options.count > 1) {
            // Utility.Companion.vibe(this@ImageEasy, 50)
